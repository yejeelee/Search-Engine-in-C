...
/**
 * Removes whitespace from the beginning and end of the given string. 
 * The final string is in the original string/char array. The terminator 
 * char is at the new end of the string. 
 */
